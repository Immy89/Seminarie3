...
class AddRecipes extends Migration
{
    ...
    public function up()
    {
        DB::table('recipe')->insert(array(
            ...
            'image' => '<img src="{{ asset(\'images/Köttbullar_med_mos.jpg\') }}" alt="Köttbullar_med_mos.jpg" />',
        ...
        DB::table('recipe')->insert(array(
            ...
            'image' => '<img src="{{ asset(\'images/Veganska_Bananpankakor.jpg\') }}" alt="Veganska_Bananpankakor.jpg" />',
            'ingredients' => '<h3>Ingredienser:</h3>
        ...
        DB::table('recipe')->insert(array(
            ...
            'image' => '<img src="{{ asset(\'images/Vietnamesiska_Pannkakor.jpg\') }}" alt="Vietnamesiska_Pannkakor.jpg" />',
            'ingredients' => '<h3>Ingredienser:</h3>
            <h4 class="header4">Pannkakor:</h4>
            <ul>
    ...
    {
        DB::table('recipe')->where('name', '=', 'Gräddkokta viltköttbullar och rårörda lingon med pepparrot')->delete();
        DB::table('recipe')->where('name', '=', 'Veganska Bananpannkakor')->delete();
        DB::table('recipe')->where('name', '=', 'Vietnamesiska Pannkakor')->delete();
    }
}
